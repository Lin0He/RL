...
2. 'tune' To for tuning of hyperparameters. Each hyperparameter you want to tune can be given seperately.
The hyperparameters that can be tuned consist of 'layer', 'unit', 'optimizer', 'batch_size', 'epochs', 'policy', 'gamma'.
An example would be:
